import { ApplicationState } from "@greenrenge/moleculer-iam-core"
...
const AppStack = () => {
  ...
  return (
    <RootStack.Navigator screenOptions={navOptions}>
      <RootStack.Screen name={"error.index"} component={ErrorScreen} />

      <RootStack.Screen name={"consent.index"} component={ConsentScreen} />

      <RootStack.Screen name={"login.index"} component={LoginIndexScreen} />
      <RootStack.Screen
        name={"login.check_password"}
        component={LoginCheckPasswordScreen}
      />

      <RootStack.Screen name={"logout.index"} component={LogoutIndexScreen} />
      <RootStack.Screen name={"logout.end"} component={LogoutEndScreen} />
      ...
      />
      <RootStack.Screen name={"register.end"} component={RegisterEndScreen} />
