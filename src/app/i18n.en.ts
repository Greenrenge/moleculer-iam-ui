...
const message = {
  ...
  "login.password.not.matched": "The password is incorrect. Please check again.",
  ...
  "placeholder.birthDay": `Enter your birthdate (ex: 940602)`,
  "placeholder.gender": "Enter your gender",
  "register.validation.phone": "The phone number is not valid. Please try again.",
  "register.validation.birthDay": "birth date is not correct. Please enter a vaild format.",
  "register.validation.gender": "The gender field value does not match any of Male, Female, Other.",
  ...
  "register.validation.name": "Please enter 1 ~ 50 characters.",
  "register.validation.email": "You have entered an invalid email address. Please try again.",
  "register.validation.email.exist": "This account is already registered. Please try using a different account.",
  "register.validation.password": "Please enter 8 ~ 32 characters.",
  "register.validation.passwordConfirmation": "password does not match. Please try again.",
