...
export const message: I18NResource = {
  ...
  "login.password.not.matched": "비밀번호가 틀립니다. 다시 시도해 주세요.",
  ...
  "placeholder.birthDay": `생년월일을 입력하세요.(예: 940602)`,
  "placeholder.gender": "성별을 입력하세요.",
  "register.validation.phone": "휴대폰 번호가 올바르지 않습니다. 다시 시도해 주세요.",
  "register.validation.birthDay": "생년월일이 올바르지 않습니다. 다시 시도해 주세요.",
  "register.validation.gender": "성별을 남성, 여성, 기타 중에 입력해주세요.",
  ...
  "register.validation.name": "1자 이상 ~ 50자 이하로 입력하세요.",
  "register.validation.email": "이메일이 올바르지 않습니다. 다시 시도해 주세요.",
  "register.validation.email.exist": "이미 등록된 계정 입니다. 다른 계정을 사용해 보세요.",
  "register.validation.password": "8자리 이상 32자리 이하로 입력하세요.",
  "register.validation.passwordConfirmation": "입력한 비밀번호와 일치하지 않습니다. 다시 시도해 주세요.",
