...
export const ActiveSessionList: React.FunctionComponent<{
  authorizedClients: ApplicationState["authorizedClients"]
}> = ({ authorizedClients }) => {
  const { formatMessage: f } = useAppI18N()
        ...
        <>
          ...
          <List
            ...
            renderItem={({
              ...
              item: (typeof authorizedClients)[number]
              index: number
            }) => {
